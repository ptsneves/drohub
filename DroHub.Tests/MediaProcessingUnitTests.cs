...
namespace DroHub.Tests {
    public class MJRPostProcessorUnitTests {
        ...
        public async void TestMJRConverterSimple() {
            ...
            try {
                var r = await MJRPostProcessor.RunConvert(TestAssetsPath, true, null);
        ...
        public async void TestGenerateVideoPreviews() {
            ...
            try {
                ...
                await LocalStorageHelper.generateVideoPreviewBatchForDirectory(temp_path, NullLogger.Instance);
