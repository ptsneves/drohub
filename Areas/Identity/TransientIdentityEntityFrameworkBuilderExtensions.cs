...
namespace DroHub.Areas.Identity {
    public static class TransientIdentityEntityFrameworkBuilderExtensions {
     /// <summary>
        ...
        public static IdentityBuilder AddTransientEntityFrameworkStores<TContext>(this IdentityBuilder builder)
        ...
        private static void AddStores(IServiceCollection services, Type userType, Type roleType, Type contextType)
        {
            ...
            {
                throw new InvalidOperationException("No identity user type");
            }
            ...
            if (roleType != null)
            {
                ...
                {
                    throw new InvalidOperationException("No identity role type");
                }
